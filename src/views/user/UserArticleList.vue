<template>
    <div class="container user-page-container flex-grow-1">
        ...
        <div class="row g-3 g-lg-8">
            <div class="col-lg-3">
                <ul
                    class="d-flex flex-row flex-lg-column justify-content-between gap-0 gap-lg-6 list-unstyled fs-info fs-lg-5">
                    <li>
                        <a href="#" class="text-default" :class="filterRules.category === undefined ? 'fw-bold' : ''" @click.prevent="filterHandle()">全部文章</a>
                    </li>
                    <li>
                        <a href="#" class="text-default" :class="filterRules.category === '最新消息' ? 'fw-bold' : ''" @click.prevent="filterHandle(['category', '最新消息'])">最新消息</a>
                    </li>
                    <li>
                        <a href="#" class="text-default" :class="filterRules.category === '活動講座' ? 'fw-bold' : ''" @click.prevent="filterHandle(['category', '活動講座'])">活動講座</a>
                    </li>
                    <li>
                        <a href="#" class="text-default" :class="filterRules.category === '專欄文章' ? 'fw-bold' : ''" @click.prevent="filterHandle(['category', '專欄文章'])">專欄文章</a>
                    </li>
                </ul>
                ...
                <div class="accordion accordion-flush" id="accordionCategory">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button fs-info fs-lg-5 bg-transparent p-0" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="collapseCategory" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body px-0 py-3 py-lg-6">
                                    <div class="d-flex gap-1 mb-0 flex-wrap">
                                        <button type="button" class="btn px-3 py-1 bg-light rounded-pill fs-info text-info" v-for="(tag, idx) in tagList.articleTagList" :key="idx" @click="filterHandle(['tag', tag])">
                                            {{ tag }}
                                        </button>
                                    </div>
                                </div>
                        ...
                        <router-link :to="`/articleinfo/${article.id}`" class="text-default">
                            <div class="ratio ratio-4x3 overflow-hidden">
                                <img :src="article.imageUrl"
                                    :alt="article.title" class="object-fit-cover w-100 h-100">
                            </div>
